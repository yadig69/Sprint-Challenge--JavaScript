...
tyrex.roar = function() { return "RAWERSRARARWERSARARARRRR!" }
...
console.log(lowCaseAnimalNames.map(i => i.toLowerCase()));
...
*/
const populationTotal = zooAnimals.reduce((cb, total) => cb + total.population, 0);
zooAnimals.reduce(function(a, b) {
